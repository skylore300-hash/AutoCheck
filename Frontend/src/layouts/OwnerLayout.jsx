    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <aside className="fixed left-0 top-0 bottom-0 w-64 bg-white border-r border-gray-200 shadow-sm">
        <div className="p-6 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-500 mt-1">Propriétaire</p>
        </div>
...
function NavLink({ icon, label, href, navigate }) {
  return (
    <button
      ...
      className="w-full text-left px-4 py-2 rounded-lg hover:bg-purple-50 text-gray-700 hover:text-purple-700 transition-colors flex items-center gap-3"
    >
